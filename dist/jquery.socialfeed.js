    ...
    $.fn.socialfeed = function (_options) {
        ...
        var Feed = {
            ...
            getTemplate: function (callback) {
                ...
                if (Feed.template) return callback();else {
                ...
                getData: function (account) {
                    ...
                    switch (account[0]) {
                        case '@':
                            ...
                            }, Feed.twitter.utility.getPosts, true // this parameter required
                            );
                            break;
                        case '#':
                ...
                utility: {
                    ...
                    unifyPostData: function (element) {
                        ...
                        if (element.id) {
                            ...
                            post.message = typeof element.text === "undefined" ? element.full_text.substr(element.display_text_range[0], element.display_text_range[1]) : element.text;
                            post.description = '';
                    ...
                    unifyPostData: function (wall_owner, element, json) {
                        ...
                        if (options.show_media) {
                            if (element.attachment) {
                                if (element.attachment.type === 'link') post.attachment = '<img class="attachment" src="' + element.attachment.link.image_src + '" />';
                                if (element.attachment.type === 'video') post.attachment = '<img class="attachment" src="' + element.attachment.video.image_big + '" />';
                                if (element.attachment.type === 'photo') post.attachment = '<img class="attachment" src="' + element.attachment.photo.src_big + '" />';
                            }
                        }
